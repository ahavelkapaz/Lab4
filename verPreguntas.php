...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>
		...
		$(document).ready(function(){
			...
			$.post("delete_q.php", { id: id_q,op: "borrar"}, function(data) {//basename($_SERVER['PHP_SELF'])
			...
			var id_q=$(this).closest('tr').find('td:first-child').text();
			$.post("delete_q.php", { id: id_q,op: "complejidad",rate:$(this).val()}, function(data) {//basename($_SERVER['PHP_SELF'])
...
<?php
	...
	echo "<br><a href='layout.html'>...o vuelve a la página principal</a>";
